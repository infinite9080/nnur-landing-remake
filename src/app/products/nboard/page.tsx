          ...
          <div className="mx-auto px-4 sm:px-6 lg:px-8" style={{ maxWidth: "1500px" }}>
            ...
            <div className="text-center">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <Link href="/?type=demo&product=nBoard#contact" className="px-8 py-4 bg-[#7030a1] text-white font-semibold rounded-lg hover:bg-[#5a2581] transition-colors duration-300 text-center">
                  Request Demo
                </Link>
                <Link href="/?type=sales&product=nBoard#contact" className="px-8 py-4 border-2 border-[#7030a1] text-[#7030a1] font-semibold rounded-lg hover:bg-[#7030a1] hover:text-white transition-colors duration-300 text-center">
                  Contact Sales
                </Link>
              </div>
            </div>
