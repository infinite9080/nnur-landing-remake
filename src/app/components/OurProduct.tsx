...
const OurProduct = () => {
  ...
  useEffect(() => {
    const timer = setInterval(() => {
      setCurrentSlide(
        (prevSlide) => (prevSlide + 1) % PRODUCT_MENU_ITEMS.length
      );
        ...
        <div className="bg-white rounded-3xl p-8 lg:p-12 shadow-xl border border-gray-100">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Explore each cybersecurity solution in detail. Our products
              automatically cycle, or you can click to learn more.
            </p>
          </div>
              ...
              <div className="space-y-4">
                {PRODUCT_MENU_ITEMS.map((product, index) => (
                  ...
                  >
                    ...
                    {currentSlide === index && (
                      <div
                        className={`px-6 pb-6 pt-2 ${styles.accordionContent}`}
                      >
                        ...
                        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
                          <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1 bg-[#7030a1]/10 text-[#7030a1] text-xs sm:text-sm font-medium rounded-full whitespace-nowrap">
                              {
                                [
                                  "Audit & Compliance",
                                  "Identity & Access Control",
                          ...
                          {product.hasPage ? (
                            <Link
                              href={product.link}
                              className="inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-[#7030a1] text-white font-semibold text-sm rounded-lg hover:bg-[#5a2581] transition-colors duration-300 w-full sm:w-auto"
                            >
                              Learn More
                              <svg
                            ...
                            <span className="inline-flex items-center justify-center px-3 sm:px-4 py-2 bg-gray-300 text-gray-500 font-semibold text-sm rounded-lg cursor-not-allowed w-full sm:w-auto">
                              Coming Soon
                            </span>
                          )}
                        </div>
