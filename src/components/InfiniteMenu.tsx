...
void main() {
    ...
    // Proper UV mapping for centered, crisp images
    vec2 st = vec2(vUvs.x, 1.0 - vUvs.y);
    
    // Apply cell offset and size for atlas texture
  ...
  private initTexture(): void {
    ...
    Promise.all(
      ...
      images.forEach((img, i) => {
        ...
        // Calculate scaling to cover the entire cell while maintaining aspect ratio
